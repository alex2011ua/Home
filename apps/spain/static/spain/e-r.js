...
document.getElementById("word").innerHTML = random_word.spain;
...
function start() {
    ...
    if (inp.toLowerCase() === to_del.russian.toLowerCase() || inp.toLowerCase() === "to " + to_del.russian.toLowerCase()) { //right input
        ...
        document.getElementById("vvod").value = '';
        answer.style.display = 'block'
        answer.innerText = to_del.russian + " - " + to_del.spain + "//" + to_del.repeat_learn + "//";
